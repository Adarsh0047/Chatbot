    ...
    def parse_job(self, response):
        ...
        if script_tag is not None:
            ...
            yield {
                ...
                'job_rating': job["companyReviewModel"]["ratingsModel"],
                'jobDescription': json_blob["jobInfoWrapperModel"]["jobInfoModel"]["sanitizedJobDescription"] if json_blob["jobInfoWrapperModel"]["jobInfoModel"]["sanitizedJobDescription"] is not None else '',
            }
